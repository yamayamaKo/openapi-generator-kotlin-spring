...
import com.yamayamako.openapi_generator.model.ModelApiResponse
import com.yamayamako.openapi_generator.model.Pet
...
interface PetApi {
    ...
    fun findPetsByStatus(
        @NotNull @Parameter(description = "Status values that need to be considered for filter", required = true, schema = Schema(allowableValues = ["available", "pending", "sold"], defaultValue = "available")) @Valid @RequestParam(value = "status", required = true, defaultValue = "available") status: kotlin.String
    ): List<Pet>
    ...
    fun updatePetWithForm(
        ...
        @Parameter(description = "Name of pet that needs to be updated") @Valid @RequestParam(value = "name", required = false) name: kotlin.String?,
        @Parameter(description = "Status of pet that needs to be updated") @Valid @RequestParam(value = "status", required = false) status: kotlin.String?
    ): Pet
    ...
    fun uploadFile(
        ...
        @Parameter(description = "Additional Metadata") @Valid @RequestParam(value = "additionalMetadata", required = false) additionalMetadata: kotlin.String?,
        @Parameter(description = "") @Valid @RequestBody(required = false) body: org.springframework.web.multipart.MultipartFile
    ): ModelApiResponse
